...
#and features of concatenated embeddings

import pandas as pd
from pathlib import Path
import numpy as np
from build_records import build_records
from features import delta_residue_feature, delta_pooled_feature, raw_wt_residue_feature, raw_mut_residue_feature
...
if __name__ == "__main__":
    ...
    for fold, (train_idx, val_idx) in enumerate(gkf.split(X, y, groups=groups)):
        ...
        #save model
        output_path = Path("./results/models/xgboost_lopo_multifeature") / f"fold_{fold+1}" / "model.json"
        ...
        #save fold results
        results_path = Path("./results/models/xgboost_lopo_multifeature") / f"fold_{fold+1}"/"results.json"
